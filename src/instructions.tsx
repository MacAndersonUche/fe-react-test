...
import {  StarIcon,
  StarBorderIcon  } from './components/icons';
...
const Instructions = () => {
  return (
    <div className="Instructions-Container">
      ...
      <div>Show 5 rating stars for the rate: filled and unfilled. <StarIcon /> <StarBorderIcon /></div>
      <div>You can install and use any 3rd party packages, material-ui is already installed</div>
